...
import { Plus, Search, Phone, Mail, MapPin, MoreVertical, Eye, Edit, Trash2 } from 'lucide-react'
                ...
                {paginatedCustomers.map((customer) => (
                  <div key={customer.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                    ...
                    <div className="flex justify-end pt-3 border-t border-gray-100">
                      <div className="relative" ref={openDropdown === `mobile-${customer.id}` ? dropdownRef : null}>
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => setOpenDropdown(openDropdown === `mobile-${customer.id}` ? null : `mobile-${customer.id}`)}
                        ...
                        {openDropdown === `mobile-${customer.id}` && (
                          <div className="absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                            <div className="py-1">
                              <button
                                onClick={() => {
